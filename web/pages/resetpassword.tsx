      ...
      <div className='flex h-screen w-screen'>
        <div className='flex justify-center w-screen xl:w-3/4 content-between'>
          <div className='md:w-2/3 xl:w-5/12 grid content-between'>
            ...
            <div className='px-6'>
              <div className='grid text-3xl font-extrabold text-center text-background pb-2'>
                <span>Password reset</span>
                <span className='text-sm font-normal'>Reset your password by entering your E-Mail adress</span>
              </div>
              <form
                onSubmit={(e) => {
                  e.preventDefault()
                ...
                <Button
                  type='submit'
                  className='bg-gradient-to-br from-menetrend-blue to-menetrend-pink hover:from-purple-900 hover:to-pink-900 font-semibold text-xl text-white py-2 px-8 rounded-md w-full'>
                  Reset your password
                </Button>
              </form>
            </div>
